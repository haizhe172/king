			                      ...
			                      <tbody>
			                          ...
			                          <tr>
		                                  ...
		                                  <td class="text-center">
		                                 	  <a href="{{url('/admin/position/edit/'.$v->position_id)}}" class="btn bg-olive btn-xs">修改</a>
                                              ...
                                              <a href="{{url('/admin/position/show/'.$v->position_id)}}" class="btn bg-olive btn-xs">查看广告</a>
                                              <a href="{{url('/admin/position/make/'.$v->position_id)}}" class="btn bg-olive btn-xs">生成广告</a>
		                                   </td>
			                          </tr>
                                      @endforeach
                                      <tr>
...
<script>
    ...
    function DeleteGetId(id,obj){
        // alert(id)
        $.get('/admin/position/del/'+id,function(res){
            if(res.code==00000){
                alert(res.msg);
                location.reload();
            }
