                            ...
                            <div class="tab-pane active" id="home">
                                <div class="row data-type">
		                           ...
		                           <div class="col-md-10 data">
		                               <input type="text" class="form-control" name="role_name" id="role_name"   placeholder="角色名称" value="">
		                           </div>
                                ...
                                <div class="row data-type">
		                           ...
		                           <div class="col-md-10 data">
		                               <textarea type="text" class="form-control" name="role_desc" id="role_desc"   placeholder="劫色介绍" style="height:70px;"></textarea>
		                           </div>
                                       <b><span id="span_name" style="color: red; font-size: 16px; margin-left: 220px;"></span></b>
                                </div>
                            </div>
